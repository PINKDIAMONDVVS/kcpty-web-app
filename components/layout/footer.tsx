    ...
    <footer className="foot">
      <div className="kpcty-container foot__inner">
          ...
          <div className="foot__col">
            <div style={{ marginBottom: 20 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12 }}>
                ...
                <span className="mono" style={{ fontSize: 13, letterSpacing: '-0.01em' }}>KPCTY</span>
                <span style={{ fontFamily: 'Noto Serif SC, serif', fontSize: 12, color: 'var(--cinnabar)', letterSpacing: '0.2em' }}>刻线</span>
              </div>
              <p className="serif" style={{ fontSize: 15, lineHeight: 1.55, color: 'var(--fg-2)', maxWidth: '34ch' }}>
                Twenty-nine one-of-one bracelets, cut from eight named mountains.
                Each is a small wish you can wear on your wrist.
              </p>
            </div>
            <div className="mono" style={{ fontSize: 10, color: 'var(--fg-3)', letterSpacing: '0.18em', textTransform: 'uppercase', lineHeight: 1.8 }}>
              Studio / Bushwick · Brooklyn<br />
              lat 40.69° · lon -73.93°<br />
              hello@kpcty.com
            </div>
          </div>
        ...
        <div className="foot__mega">
          KPCTY<span className="foot__zh">刻线</span>
        </div>

        {/* Bottom bar */}
        <div className="foot__bot">
          <span>© {new Date().getFullYear()} KPCTY · 刻线 · All rights reserved.</span>
