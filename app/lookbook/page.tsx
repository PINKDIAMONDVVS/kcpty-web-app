...
export const metadata: Metadata = {
  title: "Lookbook · 图册",
  description:
    "Issue One — A visual index of Season One on hands, wrists, books and windowsills.",
};
        ...
        >
          ...
          >
            ...
            <div style={{ textAlign: "center" }}>
              ...
              >
                Lookbook
                <span style={{ color: "var(--cinnabar)", fontStyle: "italic" }}>
                  .
                </span>
              </h1>
              <div
                className="mono up"
                style={{ fontSize: 11, opacity: 0.6, letterSpacing: "0.28em" }}
              >
            ...
            {/* Right caption */}
            <div
              className="serif look-cover-side"
              style={{
                fontSize: 18,
                textAlign: "right",
                maxWidth: 220,
            ...
            >
              <em>A visual index</em> of S1 on hands, wrists, books and
              windowsills.
            </div>
          </div>
        </section>
        ...
        <section style={{ borderBottom: "1px solid var(--line)" }}>
          ...
          >
            ...
            <LookCell span={2} row={2}>
              <LookImg
                src="/products_sq/p20.jpg"
                alt="Season One plate 02 — Tianhe stone"
              />
              <Badge style={{ bottom: 16, left: 16 }}>
                PLATE 02 · TIANHE STONE
              </Badge>
            </LookCell>
            ...
            <LookCell span={2} row={1} bg="var(--bg-2)">
              ...
              >
                ...
                <p className="serif" style={{ fontSize: 19, lineHeight: 1.35 }}>
                  A friend once said: "If I can't remember what I was worrying
                  about, it means I've been{" "}
                  <em style={{ color: "var(--cinnabar)" }}>
                    working the beads
                  </em>{" "}
                  right."
                </p>
            ...
            <LookCell span={1} row={1} bg="var(--bg)" color="var(--fg)">
              ...
              >
                <div
                  className="mono"
                  style={{ fontSize: 9, letterSpacing: "0.18em", opacity: 0.6 }}
                >
                  P. 008
                </div>
                <div
            ...
            <LookCell span={2} row={1} bg="var(--bg-3)">
              ...
              >
                ...
                <p className="serif" style={{ fontSize: 18, lineHeight: 1.35 }}>
                  The <em style={{ color: "var(--cinnabar)" }}>knot</em> is a
                  technique, not an accident. Every end is finished with a
                  double Chinese button knot (纽棒结) — the same knot scholars
                  used to secure seal cases.
                </p>
              </div>
            </LookCell>
            ...
            <LookCell span={3} row={2}>
              <LookImg
                src="/products_tall/p28.jpg"
                alt="Season One plate 03 — Honey amber"
              />
              <Badge style={{ top: 16, right: 16 }}>
                PLATE 03 · HONEY AMBER
              </Badge>
            </LookCell>
            ...
            <LookCell span={2} row={2}>
              <LookImg
                src="/products_tall/p5.jpg"
                alt="Season One piece 05 tall"
              />
            </LookCell>
            ...
            <LookCell span={2} row={1} bg="var(--bg-2)">
              ...
              >
                <p
                  className="serif"
                  style={{ fontSize: 18, lineHeight: 1.4, marginBottom: 14 }}
                >
                  <em>
                    "I thought beads were for retired aunties. Now my retired
                    aunties are jealous of mine."
                  </em>
                </p>
                <div
                  className="mono up"
            ...
            <LookCell span={3} row={1} bg="var(--bg-2)">
              ...
              >
                ...
                <div
                  className="display"
                  style={{ fontSize: 44, lineHeight: 0.95 }}
                >
                  See the{" "}
                  <em style={{ color: "var(--cinnabar)", fontStyle: "italic" }}>
                    full drop →
